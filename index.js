...
var currentLineofPeopleArray //array of names of everyone in line
...
function takeANumber(currentLineofPeopleArray, newPersonsName){
  ...
  //write welcomeMessage using newPersonsName & newPersonsName position in line
let welcomeMessage = `Welcome ${newPersonsName}.  You are number ${currentLineofPeopleArray[3]}  in line.`
